<?php
	...
	class Formulario{
		...
		public static function titulo($texto, $obligatorio = false){
            if($texto=="") $texto = "&nbsp;";
            return '<div class="texto_arriba" style="font-weight: bold;" align="left">'.($obligatorio ? '<span style="color: red; font-weight: bold;">*</span> ' : '').$texto.'</div>';
        }
        
        public static function subtitulo($texto, $obligatorio = false){
            if($texto=="") $texto = "&nbsp;";
            return '<div class="texto_abajo" align="right">'.($obligatorio ? '<span style="color: red; font-weight: bold;">*</span> ' : '').$texto.'</div>';
        }
